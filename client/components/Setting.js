      ...
      <div className="setting-outer">
        <div className="setting-img">
          <img
            ...
            src={
              imageUrl == null
                ? "https://tise-static.telenorcdn.net/profile-pictures/5fa982dbe2fe150012e3930e/32ff5636-7dae-42ec-9e32-e6846afda0ad"
                : imageUrl
            }
          />
        ...
        <div className="setting-inner1">
          ...
          <Dialog open={this.state.open} onClose={this.handleClose}>
            ...
            <DialogActions>
              <Button id="open" onClick={this.handleClose}>
                Cancel
              </Button>
              <Button id="open" onClick={this.handleSubmit}>
                Update
              </Button>
            </DialogActions>
          </Dialog>
          ...
          <Dialog open={this.state.open1} onClose={this.handleClose}>
            ...
            <DialogActions>
              <Button id="open1" onClick={this.handleClose}>
                Cancel
              </Button>
              <Button id="open1" onClick={this.handleSubmit}>
                Update
              </Button>
            </DialogActions>
          </Dialog>
          ...
          <Dialog open={this.state.open2} onClose={this.handleClose}>
            ...
            <DialogActions>
              <Button id="open2" onClick={this.handleClose}>
                Cancel
              </Button>
              <Button id="open2" onClick={this.handleSubmit}>
                Update
              </Button>
            </DialogActions>
          </Dialog>
          ...
          <Dialog open={this.state.open3} onClose={this.handleClose}>
            ...
            <DialogActions>
              <Button id="open3" onClick={this.handleClose}>
                Cancel
              </Button>
              <Button id="open3" onClick={this.handleSubmit}>
                Update
              </Button>
            </DialogActions>
          </Dialog>
          ...
          <Dialog open={this.state.open4} onClose={this.handleClose}>
            ...
            <DialogActions>
              <Button id="open4" onClick={this.handleClose}>
                Cancel
              </Button>
              <Button id="open4" onClick={this.handleSubmit}>
                Update
              </Button>
            </DialogActions>
          </Dialog>
          ...
          <Dialog open={this.state.open5} onClose={this.handleClose}>
            ...
            <DialogActions>
              <Button id="open5" onClick={this.handleClose}>
                Cancel
              </Button>
              <Button id="open5" onClick={this.handleSubmit}>
                Update
              </Button>
            </DialogActions>
          </Dialog>
